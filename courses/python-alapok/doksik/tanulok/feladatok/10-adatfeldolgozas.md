# Feladatok – 10. hét: Adatfeldolgozás
...
Adott szótárak listája (tanulók: név, pontszám). Keresd meg és írd ki a legjobb és legrosszabb pontszámú tanulót (ne használj `min()`/`max()` beépített függvényt!).
